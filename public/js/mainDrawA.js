...
var canvasWidth = document.getElementById('whiteboard').clientWidth;
var canvasHeight = document.getElementById('whiteboard').clientHeight;
FULLSCREEN = false;
var canvasOffsetTop = $("#whiteboard").offset().top //canvas相对浏览器窗口的偏移量
var canvasOffsetTopStatic = canvasOffsetTop;
var canvasOffsetLeft = $("#whiteboard").offset().left //canvas相对浏览器窗口的偏移量
