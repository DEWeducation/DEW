...
public class FrageHotsNews extends BaseLazyFragment implements LoadMoreListener.OnLoadMoreListener {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        mRootView.findViewById(R.id.btn_1).setVisibility(View.GONE);
...
//
    ...
    private void getData() {
        ...
        String urlLocalHot = "http://182.254.132.190:8080/hot.html";
        HttpUtil.get(urlLocalHot, new ResponseHandler() {
            @Override
