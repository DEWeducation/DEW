...
public class FragSetting extends PreferenceFragment
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        getPreferenceScreen().removePreference(findPreference("group_tail"));//这是 删除整个 一级节点
        ((PreferenceGroup)findPreference("group_other")).removePreference(findPreference("open_sourse"));
        ((PreferenceGroup)findPreference("fuck")).removePreference(findPreference("setting_forums_url"));
