...
public class PostsActivity extends BaseActivity implements
    ...
    private void getData() {
        ...
        if (FID == 72)
           url = "http://182.254.132.190:8080/myquestion.html";
        else if (FID == 550)
            url = "http://182.254.132.190:8080/myanswer.html";
        else if (FID == 549)
            url = "http://182.254.132.190:8080/mystar.html";
        else
        {
            url = "http://182.254.132.190:8080/none.html";
        }
    ...
    private class getPostsMe extends AsyncTask<String, Void, List<ArticleListData>> {
        ...
        protected List<ArticleListData> doInBackground(String... params) {
            ...
            if (FID == 72)
            {
                temp = new ArticleListData(false, "[提问]三角形是什么", "1.html", "令狐聪", "2", -1172690);
                dataset.add(temp);
                temp = new ArticleListData(false, "[提问]奥特曼定理是什么", "2.html", "屈俊平", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[提问]小明会数学吗", "3.com", "小王", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[提问]勾股定理是什么", "4.com", "屈俊平", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[提问]勾股定理是什么", "5.com", "欧阳锋", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[提问]勾股定理是什么", "6.com", "屈俊平", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[提问]勾股定理是什么", "7.com", "石吉", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[提问]勾股定理是什么", "8.com", "王聪", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[提问]勾股定理是什么", "9.com", "旺发", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[提问]勾股定理是什么", "10.com", "屈俊平", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[提问]勾股定理是什么", "11.com", "小明", "1", -16448251);
                dataset.add(temp);
            }
            else if(FID == 550)
            {
                temp = new ArticleListData(false, "[回答]***是什么", "1.html", "令狐聪", "2", -1172690);
                dataset.add(temp);
                temp = new ArticleListData(false, "[回答]***是什么", "2.html", "屈俊平", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[回答]***是什么数学吗", "3.com", "小王", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[回答]***是什么是什么", "4.com", "屈俊平", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[回答]***是什么是什么", "5.com", "欧阳锋", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[回答]***是什么勾股定理是什么", "6.com", "屈俊平", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[回答]***是什么勾股定理是什么", "7.com", "石吉", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[回答]***是什么勾股定理是什么", "8.com", "王聪", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[回答]***奥特曼是什么", "9.com", "旺发", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[回答]***是什么勾股定理是什么", "10.com", "屈俊平", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[回答]***是什么勾股定理是什么", "11.com", "小明", "1", -16448251);
                dataset.add(temp);
            }
            else if (FID == 549)
            {
                temp = new ArticleListData(true, "[收藏]***是什么", "1.html", "令狐聪", "2", -1172690);
                dataset.add(temp);
                temp = new ArticleListData(false, "[收藏]***是什么", "2.html", "屈俊平", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[收藏]***是什么数学吗", "3.com", "小王", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[收藏]***是什么是什么", "4.com", "屈俊平", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[收藏]***是什么是什么", "5.com", "欧阳锋", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[收藏]***是什么勾股定理是什么", "6.com", "屈俊平", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[收藏]***是什么勾股定理是什么", "7.com", "石吉", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[收藏]***是什么勾股定理是什么", "8.com", "王聪", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[收藏]***奥特曼是什么", "9.com", "旺发", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[收藏]***是什么勾股定理是什么", "10.com", "屈俊平", "1", -16448251);
                dataset.add(temp);
                temp = new ArticleListData(false, "[收藏]***是什么勾股定理是什么", "11.com", "小明", "1", -16448251);
                dataset.add(temp);
            }else{
                temp = new ArticleListData(false, "功能正在开发，请稍后再试", "1.html", "NULL", "0", -16448251);
                dataset.add(temp);
            }
            * */
...
//            temp = new ArticleListData(false, "三角形是什么", "1.html", "令狐聪", "2", -1172690);
//            dataset.add(temp);
//            temp = new ArticleListData(false, "奥特曼定理是什么", "2.html", "屈俊平", "1", -16448251);
//            dataset.add(temp);
//            temp = new ArticleListData(false, "小明会数学吗", "3.com", "小王", "1", -16448251);
//            dataset.add(temp);
//            temp = new ArticleListData(false, "勾股定理是什么", "4.com", "屈俊平", "1", -16448251);
//            dataset.add(temp);
//            temp = new ArticleListData(false, "勾股定理是什么", "5.com", "欧阳锋", "1", -16448251);
//            dataset.add(temp);
//            temp = new ArticleListData(false, "勾股定理是什么", "6.com", "屈俊平", "1", -16448251);
//            dataset.add(temp);
//            temp = new ArticleListData(false, "勾股定理是什么", "7.com", "石吉", "1", -16448251);
//            dataset.add(temp);
//            temp = new ArticleListData(false, "勾股定理是什么", "8.com", "王聪", "1", -16448251);
//            dataset.add(temp);
//            temp = new ArticleListData(false, "勾股定理是什么", "9.com", "旺发", "1", -16448251);
//            dataset.add(temp);
//            temp = new ArticleListData(false, "勾股定理是什么", "10.com", "屈俊平", "1", -16448251);
            dataset.add(temp);
